...
export default function BBAFinanceHero() {
  return (
    <section className="relative bg-alpine-blue w-full pt-12 pb-24 overflow-hidden border-b-2 border-summit-orange">
      ...
      <div className="max-w-[1570px] mx-auto px-4 sm:px-10 relative z-10">
        ...
        >
          ...
          <span>/</span>
          <span className="text-white normal-case">BBA – Finance</span>
        </motion.div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-[55%] text-center lg:text-left">
            ...
            <div className="overflow-hidden mb-2">
              <motion.h1
                className="text-white text-[52px] sm:text-[80px] md:text-[100px] leading-none font-normal tracking-tight font-sans uppercase"
            ...
            >
              The BBA (Finance) program at AMC equips students with comprehensive knowledge
              and practical skills in financial management, investment strategies, and business
              operations — developing the analytical and decision-making abilities essential
