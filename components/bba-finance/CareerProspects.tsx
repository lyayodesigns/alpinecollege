...
const careerPaths = [
  {
    ...
    subtitle: "Credit Analyst · Financial Analyst · Investment Banker",
    icon: (
  ...
  },
  {
    ...
    subtitle: "Finance Manager · Financial Planner · Risk Analyst",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    subtitle: "Portfolio Manager · Investment Analyst · Stockbroker",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    subtitle: "Financial Auditor · Policy Analyst · Treasury Officer",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    subtitle: "Underwriter · Claims Analyst · Risk Manager",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    title: "NGOs & Business Consulting",
    subtitle: "Finance Officer · Budget Analyst · Business Consultant",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <section ref={ref} className="bg-snow-white py-[80px] sm:py-[120px] pb-[100px] sm:pb-[140px]">
      <div className="w-full max-w-[1570px] mx-auto px-4 sm:px-10">
        ...
        <div className="max-w-[820px] mb-16 mx-auto sm:mx-0 text-center sm:text-left">
          ...
          >
            A BBA (Finance) degree from AMC opens doors to a wide range of career paths
            across banking, corporate finance, investment firms, and the public sector.
          </motion.p>
        </div>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col gap-5">
              ...
              <h3 className="m-0 text-white text-[24px] sm:text-[32px] leading-tight font-normal uppercase">
                Elevate with an MBA in Finance
              </h3>
              <p className="m-0 text-white/65 text-base leading-[1.8] normal-case">
                Pursuing an MBA with a specialization in Finance can further enhance career
                prospects, enabling graduates to secure senior-level positions at multinational
                organizations and financial institutions.
              </p>
              <p className="m-0 text-white/65 text-base leading-[1.8] normal-case">
                MBA (Finance) professionals command significantly higher remuneration and are
                positioned to navigate complex financial decisions at the highest levels of
                global enterprises.
              </p>
              <div className="pt-2 mt-auto flex flex-wrap gap-3">
                {["Financial Controller", "CFO", "Director of Finance", "Investment Director"].map((role, i) => (
