...
const stats = [
  { value: "4", suffix: "", unit: "Years", label: "Program Duration", desc: "A comprehensive four-year undergraduate degree with a Finance specialization" },
  { value: "8", suffix: "", unit: "Semesters", label: "Academic Structure", desc: "Progressively structured, with project work and internship in the final years" },
  { value: "126", suffix: "+", unit: "Credits", label: "Total Credit Hours", desc: "Coursework, project work, and internship combined" },
];
