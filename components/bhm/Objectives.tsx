...
const objectives = [
  "To provide students with a comprehensive understanding of theoretical knowledge and practical skills in the field of hotel management.",
  "To enhance students' communication skills, enabling them to effectively interact with guests, colleagues, and stakeholders in the hospitality industry.",
  "To develop students' decision-making abilities and critical thinking skills, enabling them to analyze and solve complex problems in hotel management.",
  "To foster students' entrepreneurial mindset and skills, encouraging them to identify and seize opportunities in the hospitality and tourism industry.",
  "To lay a strong foundation for students to pursue further education, such as postgraduate studies or specialized certifications in the field of hotel management.",
];
      ...
      <div className="w-full max-w-[1570px] mx-auto px-4 sm:px-10">
        <div className="grid grid-cols-1 min-[900px]:grid-cols-2 gap-12 min-[900px]:gap-20 items-center">
          ...
          <div className="flex flex-col gap-6 text-center min-[900px]:text-left">
            ...
            >
              Some of the key objectives of the BHM program are as follows:
            </motion.p>
            <motion.div
