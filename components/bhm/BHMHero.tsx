...
export default function BHMHero() {
  return (
    <section className="relative bg-alpine-blue w-full pt-12 pb-24 overflow-hidden border-b-2 border-summit-orange">
      ...
      <div className="max-w-[1570px] mx-auto px-4 sm:px-10 relative z-10">
        ...
        >
          ...
          <span>/</span>
          <span className="text-white normal-case">BHM</span>
        </motion.div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-[55%] text-center lg:text-left">
            ...
            >
              The BHM program at AMC prepares graduates for careers in the hospitality
              and tourism industry as managers, leaders, and entrepreneurs — combining
              management theory with hands-on hospitality courses and internship experience.
            </motion.p>
            ...
            >
              {[
                ...
                { value: "122 Credits", label: "Coursework" },
                { value: "35 Courses", label: "Curriculum" },
              ].map((stat, i) => (
                <div
                  key={i}
          ...
          >
            <div className="rounded-tl-[80px] rounded-br-[80px] sm:rounded-tl-[120px] sm:rounded-br-[120px] overflow-hidden">
              <Image
                src="/homepage/BHM HEAD.avif"
                alt="BHM Students at Alpine Management College"
                width={800}
                height={580}
            ...
            <div className="absolute -bottom-5 -left-3 sm:-bottom-7 sm:-left-5 bg-summit-orange text-white px-6 py-4 rounded-2xl shadow-xl">
              <p className="text-[10px] uppercase tracking-widest opacity-80 m-0 mb-1">Affiliated with</p>
              <p className="text-2xl font-bold leading-none m-0">Pokhara Uni.</p>
            </div>
          </motion.div>
        </div>
      </div>
