...
const objectives = [
  ...
  "Be well acquainted with the broad contexts of business organizations in Nepal and outside.",
  ...
  "Have the ability to work in teams and individually.",
  "Have awareness of the environmental factors, social/functional relationships, and ethical standards that affect business and administrative decisions.",
];
      ...
      <div className="w-full max-w-[1570px] mx-auto px-4 sm:px-10">
        <div className="grid grid-cols-1 min-[900px]:grid-cols-2 gap-12 min-[900px]:gap-20 items-center">
          ...
          <div className="flex flex-col gap-6 text-center min-[900px]:text-left">
            ...
            >
              The BBA program is designed so that graduates will:
            </motion.p>
            <motion.div
