...
const curriculumItems = [
  {
    ...
    desc: "Core academic foundations across business and social sciences",
  ...
  {
    title: "Core Courses",
    desc: "Business management, finance, marketing, and HR essentials",
  ...
  },
  {
    ...
    desc: "Specialized topics chosen to align with individual career goals",
    iconBg: "bg-alpine-blue-50",
    iconColor: "text-alpine-blue",
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    desc: "Hands-on project in Semester 6 and industry internship in Semester 7",
    iconBg: "bg-summit-orange-50",
    iconColor: "text-summit-orange",
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="w-full max-w-[1570px] mx-auto px-4 sm:px-10">
        <div className="grid grid-cols-1 gap-12 items-center min-[900px]:grid-cols-2 min-[900px]:gap-20">
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              The Bachelor of Business Administration (BBA) program of Pokhara University
              aims to provide students with foundational knowledge and practical skills
              in various areas of business administration. It develops intellectual ability
              and managerial skills through business and social science courses, helping
              students cultivate the attitudes and qualities required for managing business
            ...
            >
              Spanning four years across eight semesters, students must complete 126 credit
              hours of coursework, project work, and internship for graduation. The project
              work in the sixth semester and internship in the seventh semester are the most
              enriching and rewarding phases of the BBA journey.
            </motion.p>
          </div>
