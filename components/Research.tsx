...
export default function Research() {
  ...
  return (
    <section ref={ref} className="overflow-hidden font-medium bg-deep-midnight">
      ...
      <div className="w-full max-w-[1570px] mx-auto px-10 overflow-hidden mb-[30px]">
        {/* Header */}
        <div className="pt-[60px] relative z-0 grid grid-cols-[1fr_2fr] gap-4">
          ...
          <div>
            {[
              ...
              <motion.h2
                key={i}
                className={`m-0 text-white text-[56px] leading-[75px] font-normal -tracking-[0.01em] uppercase ${line.mb ? "mb-[30px]" : ""}`}
        ...
        >
          ...
          >
            {researchItems.map((item, index) => (
              <motion.div
                key={index}
                className="group relative z-0 max-w-[620px] w-[620px] shrink-0 transition-transform duration-300 hover:-translate-y-2"
              ...
              >
                ...
                <h3 className="max-w-[600px] mb-7 text-white text-[40px] leading-[120%] font-normal capitalize transition-colors duration-300 group-hover:text-alpine-blue">
                  {item.title}
                </h3>
                <p className="max-w-[456px] text-white/65 text-xl leading-[125%] font-normal capitalize">
                  {item.description}
                </p>
              </motion.div>
            ))}
        ...
        >
          <a
            href="#"
            className="group relative flex justify-center items-center mt-[55px] px-[51px] py-6 border border-summit-orange rounded-full no-underline overflow-hidden transition-colors duration-200 hover:bg-summit-orange w-fit mx-auto"
          >
