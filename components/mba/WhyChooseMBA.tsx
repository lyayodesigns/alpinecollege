...
const whyItems = [
  {
    ...
    desc: "Gain a comprehensive understanding of business management principles, strategies, and their application at the executive level.",
    icon: (
  ...
  {
    title: "Global Business Dynamics",
    desc: "Become well-acquainted with global business dynamics, economic policies, and organizational management across international markets.",
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    title: "Strategic Analytical Thinking",
    desc: "Demonstrate strong analytical, critical thinking, and problem-solving skills essential for high-level managerial decision-making.",
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    title: "Business Analytics & Technology",
    desc: "Become adept at utilizing advanced business analytics, electronic media, and software solutions for organizational improvement.",
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    desc: "Build the ability to lead effectively in both collaborative teams and independently, navigating complex organizational challenges.",
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    desc: "Understand ethical considerations, corporate governance, and regulatory requirements affecting business decisions at every level.",
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function WhyChooseMBA() {
      ...
      <div className="w-full max-w-[1570px] mx-auto px-4 sm:px-10">
        <div className="max-w-[720px] mb-16 mx-auto sm:mx-0 text-center sm:text-left">
          ...
          >
            ...
            the advanced skills, knowledge, and leadership mindset to excel in
            Nepal&apos;s dynamic business environment and on the global stage.
          </motion.p>
        </div>
