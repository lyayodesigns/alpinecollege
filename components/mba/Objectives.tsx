...
const objectives = [
  "Develop strategic thinking and leadership capabilities required for high-level business decision-making.",
  "Foster analytical skills to evaluate business performance and market trends.",
  "Enhance students' ability to manage organizational operations effectively and efficiently.",
  "Equip students with practical skills to solve business problems using data-driven decision-making techniques.",
  "Promote teamwork, leadership, and effective communication skills in business settings.",
  "Create awareness of global business practices, ethical standards, and corporate social responsibility.",
];
      ...
      <div className="w-full max-w-[1570px] mx-auto px-4 sm:px-10">
        <div className="grid grid-cols-1 min-[900px]:grid-cols-2 gap-12 min-[900px]:gap-20 items-center">
          ...
          <div className="flex flex-col gap-6 text-center min-[900px]:text-left">
            ...
            >
              The key objectives of the MBA program are as follows:
            </motion.p>
            <motion.div
