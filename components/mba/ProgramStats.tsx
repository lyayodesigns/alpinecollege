...
const stats = [
  { value: "2", suffix: "", unit: "Years", label: "Program Duration", desc: "An intensive two-year postgraduate degree program" },
  { value: "4", suffix: "", unit: "Semesters", label: "Academic Structure", desc: "Progressively structured, with project work and internship in final semesters" },
  { value: "66", suffix: "", unit: "Credits", label: "Total Credit Hours", desc: "Coursework, specialization, project work, and internship combined" },
];
