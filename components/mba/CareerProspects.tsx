...
const careerPaths = [
  {
    ...
    subtitle: "Business Manager · Project Manager · Operations Manager",
    icon: (
  ...
  },
  {
    ...
    subtitle: "Credit Manager · Financial Analyst · Investment Manager",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    subtitle: "Marketing Manager · Brand Manager · Sales Director",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    subtitle: "HR Manager · Talent Acquisition Manager · OD Consultant",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    title: "IT Management",
    subtitle: "IT Manager · Business Analyst · IT Project Manager",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    subtitle: "Policy Analyst · Public Administrator · Economic Advisor",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    subtitle: "Business Consultant · Startup Founder · Strategy Consultant",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <section ref={ref} className="bg-snow-white py-[80px] sm:py-[120px] pb-[100px] sm:pb-[140px]">
      <div className="w-full max-w-[1570px] mx-auto px-4 sm:px-10">
        ...
        <div className="max-w-[820px] mb-16 mx-auto sm:mx-0 text-center sm:text-left">
          ...
          >
            An MBA from AMC opens doors to a wide array of career paths across corporate
            management, banking, marketing, HR, technology, and the public sector.
          </motion.p>
        </div>

        <div className="grid grid-cols-1 min-[900px]:grid-cols-[1fr_420px] gap-10 items-start">
          {/* Career path cards */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {careerPaths.map((career, index) => (
              <motion.div
                key={index}
                className="group flex items-start gap-4 p-5 rounded-[16px] border border-rock-grey/15 bg-white hover:bg-alpine-blue hover:border-alpine-blue transition-all duration-300 hover:shadow-[0_16px_40px_rgba(46,143,191,0.2)] hover:-translate-y-1"
              ...
              >
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <span className="text-rock-grey text-[12px] leading-snug normal-case group-hover:text-white/65 transition-colors duration-300">{career.subtitle}</span>
                </div>
              </motion.div>
            ))}
          </div>

          {/* Executive roles highlight panel */}
          <motion.div
            className="relative rounded-[24px] bg-deep-midnight p-8 sm:p-10 overflow-hidden flex flex-col gap-6"
          ...
          >
            ...
            <div className="relative z-10 flex flex-col gap-5">
              ...
              <p className="m-0 text-white/65 text-base leading-[1.8] normal-case">
                An MBA lays the foundation for top-tier executive roles in multinational
                corporations. MBA graduates are highly valued for their strategic insight,
                leadership capabilities, and global business acumen.
              </p>
              <p className="m-0 text-white/65 text-base leading-[1.8] normal-case">
                From directing entire divisions to leading global enterprises, an MBA from
                AMC positions you for the highest levels of organizational leadership.
              </p>
              <div className="pt-2 mt-auto flex flex-wrap gap-3">
                {["Director", "Vice President", "CEO", "COO"].map((role, i) => (
