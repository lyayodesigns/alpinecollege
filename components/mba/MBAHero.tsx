    ...
    <section className="relative bg-alpine-blue w-full pt-12 pb-24 overflow-hidden border-b-2 border-summit-orange">
      ...
      <div className="max-w-[1570px] mx-auto px-4 sm:px-10 relative z-10">
        ...
        >
          ...
          <span>/</span>
          <span className="text-white normal-case">MBA</span>
        </motion.div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-[55%] text-center lg:text-left">
            ...
            >
              Postgraduate Program · Pokhara University
            </motion.p>
            ...
            >
              The MBA program at AMC develops advanced business and managerial skills,
              enhancing analytical, strategic, and leadership capabilities to prepare
              graduates for top management roles across diverse sectors globally.
            </motion.p>
            ...
            >
              {[
                ...
                { value: "4 Semesters", label: "Structure" },
                { value: "66 Credits", label: "Coursework" },
                { value: "Postgraduate", label: "Level" },
              ].map((stat, i) => (
                <div
                  key={i}
