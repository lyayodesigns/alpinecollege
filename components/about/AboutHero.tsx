...
const facts = [
  ...
  { label: "Location", value: "Nepalgunj, Banke" },
  { label: "Affiliated with", value: "Pokhara University" },
  { label: "Programs", value: "BBA · BHM · MBA" },
];

export default function AboutHero() {
  return (
    <section className="relative flex flex-col bg-alpine-blue overflow-hidden" style={{ minHeight: "92vh" }}>
      {/* Background image */}
        ...
        <div className="flex-1 flex flex-col justify-center py-16 sm:py-20">
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-summit-orange/40 text-summit-orange text-xs font-semibold tracking-[0.12em] uppercase">
              ...
              Est. 2009 · Pioneer in Western Nepal
            </span>
          </motion.div>
          ...
          {/* Subtitle row */}
          <motion.div
            className="mt-10 flex flex-col sm:flex-row items-start sm:items-center gap-8 max-w-[800px]"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.65, delay: 0.75 }}
          >
            <p className="m-0 text-white/65 text-base sm:text-lg leading-[1.75] normal-case max-w-[480px]">
              The premier management institution in Nepalgunj — delivering world-class Business Administration and Hotel Management education since 2009.
            </p>
            <div className="flex flex-wrap gap-3 flex-shrink-0">
              <a
                href="#about-section"
                className="inline-block bg-summit-orange text-white font-semibold text-sm px-6 py-3 rounded-full hover:bg-summit-orange-600 transition-all no-underline"
              >
                Learn More
              </a>
              <a
                href="#"
                className="inline-block border border-white/40 text-white font-semibold text-sm px-6 py-3 rounded-full hover:bg-white/10 transition-all no-underline"
              >
                Apply Now
              </a>
            </div>
