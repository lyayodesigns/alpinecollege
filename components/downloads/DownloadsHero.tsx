...
export default function DownloadsHero() {
  return (
    <section className="relative overflow-hidden bg-deep-midnight pt-[100px] pb-[80px]">
      <div className="pointer-events-none absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-summit-orange/10 blur-[130px]" />
      <div className="pointer-events-none absolute -bottom-20 -left-20 w-[400px] h-[400px] rounded-full bg-alpine-blue/15 blur-[100px]" />
      ...
      <div className="relative w-full max-w-[1570px] mx-auto px-4 sm:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_1.8fr] gap-6 items-end">
          ...
          >
            Access and download official brochures, admission forms, syllabi,
            and important notices from Alpine Management College.
          </motion.p>
        </div>
      </div>
    </section>
